# iOS build templates.
scons platform=ios target=template_debug tools=no build_profile="kaetram.build" arch=arm64 precision=double
scons platform=ios target=template_release tools=no build_profile="kaetram.build" arch=arm64 precision=double
scons platform=ios target=template_debug tools=no build_profile="kaetram.build" ios_simulator=yes arch=arm64 precision=double
scons platform=ios target=template_release tools=no build_profile="kaetram.build" ios_simulator=yes arch=arm64 precision=double generate_bundle=yes
...
scons platform=macos target=template_debug tools=no build_profile="kaetram.build" arch=x86_64 precision=double
scons platform=macos target=template_release tools=no build_profile="kaetram.build" arch=x86_64 precision=double
scons platform=macos target=template_debug tools=no build_profile="kaetram.build" arch=arm64 precision=double
scons platform=macos target=template_release tools=no build_profile="kaetram.build" arch=arm64 precision=double generate_bundle=yes
