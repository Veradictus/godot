...
scons platform=ios target=template_release tools=no build_profile="kaetram.build" ios_simulator=yes arch=arm64 precision=double
...
scons platform=macos target=template_release tools=no build_profile="kaetram.build" arch=arm64 precision=double
